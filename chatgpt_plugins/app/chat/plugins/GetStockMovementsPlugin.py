...
class GetStockMovementsPlugin(PluginInterface):

    def get_name(self) -> str:
        return "get_stock_movements"

    def get_description(self) -> str:
        return "Get a list of stock movements for a specific company via API."
    ...
    def execute(self, **kwargs) -> Dict:
        ...
        response = requests.get('http://127.0.0.1:5000/stock-movements', json=json_data)
