...
class GetBatchesPlugin(PluginInterface):

    def get_name(self) -> str:
        return "get_batches"

    def get_description(self) -> str:
        return "Get a list of batches for a specific item by its ID via API."
    ...
    def get_parameters(self) -> Dict:
        ...
        parameters = {
            ...
            "properties": {
                ...
                "item_id": {
                    "type": "string",
                    "description": "ID of the item to get batches for"
                }
            },
    ...
    def execute(self, **kwargs) -> Dict:
        ...
        response = requests.get(f'http://127.0.0.1:5000/batches/{item_id}', json=json_data)
