...
class GetLocationsPlugin(PluginInterface):

    def get_name(self) -> str:
        return "get_locations"

    def get_description(self) -> str:
        return "Get a list of locations for a specific company via API."

    def get_parameters(self) -> Dict:
        """
        Return the parameters required for this plugin.
        In this case, there is one parameter: 'company_name'.
        """
        parameters = {
            "type": "object",
            "properties": {
    ...
    def execute(self, **kwargs) -> Dict:
        ...
        response = requests.get(f'http://127.0.0.1:5000/locations', json=json_data)
